...
namespace DS {
    ...
    template<typename T> using is_my_integral = typename std::conditional_t<
        std::is_integral<T>::value || std::is_base_of<MyIntegralIndicator, T>::value,
        std::true_type,
        std::false_type
    >;
    template<typename T> constexpr bool is_my_integral_v = is_my_integral<T>::value;
    ...
    template<typename T> using is_signed_int = typename std::conditional_t<
        ...
        std::false_type
    >;
    template<typename T> constexpr bool is_signed_int_v = is_signed_int<T>::value;
