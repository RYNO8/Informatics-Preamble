...
std::map<typename iterator_traits<Iterator>::value_type, typename iterator_traits<Iterator>::value_type> coordCompressMap(Iterator begin, Iterator end, int startI = 0) {
