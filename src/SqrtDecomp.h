...
// Mo's algorithm
template<typename T> std::vector<T> chunkQueries(std::vector<std::pair<int, int>> &queries_, function<void(int)> add, function<void(int)> rem, function<T(int, int)> answer) {
